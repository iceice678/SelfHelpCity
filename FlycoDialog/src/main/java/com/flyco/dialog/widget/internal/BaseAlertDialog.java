...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
     ...
     * btn text(按钮内容)
     */
    protected String mBtnLeftText = mContext.getString(R.string.cancel);
    protected String mBtnRightText = mContext.getString(R.string.confirm);
    protected String mBtnMiddleText = mContext.getString(R.string.carry_on);
    /**
