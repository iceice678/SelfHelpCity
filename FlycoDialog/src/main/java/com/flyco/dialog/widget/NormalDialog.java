...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    public NormalDialog(Context context) {
        ...
        mTitleTextSize = 22f;
        mContentTextColor = Color.parseColor("#999999");
        mContentTextSize = 17f;
        mLeftBtnTextColor = Color.parseColor("#000000");
        mLeftBtnTextSize = 19f;
        mRightBtnTextColor = Color.parseColor("#F86442");
        mRightBtnTextSize = 19f;
        mMiddleBtnTextColor = Color.parseColor("#000000");
        mMiddleBtnTextSize = 19f;
    ...
    public View onCreateView() {
        ...
        /** btns */
        mTvBtnLeft.setLayoutParams(new LinearLayout.LayoutParams(0, dp2px(55), 1));
        ...
        mTvBtnMiddle.setLayoutParams(new LinearLayout.LayoutParams(0, dp2px(55), 1));
        ...
        mTvBtnRight.setLayoutParams(new LinearLayout.LayoutParams(0, dp2px(55), 1));
    ...
    public void setUiBeforShow() {
        ...
        mVLineTitle.setVisibility(isShowLine ? View.VISIBLE : View.GONE);
     ...
     */
    public NormalDialog titleLineShow(boolean isShow) {
