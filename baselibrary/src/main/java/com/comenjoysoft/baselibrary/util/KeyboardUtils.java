...
public final class KeyboardUtils {
     ...
     */
    public static void showSoftInput(Context context, final Activity activity) {
        showSoftInput(context, activity, InputMethodManager.SHOW_FORCED);
    }
     ...
     */
    public static void showSoftInput(Context context, final Activity activity, final int flags) {
        View view = activity.getCurrentFocus();
        if (view == null) {
            view = new View(activity);
        }
        showSoftInput(context, view, flags);
    }
     ...
     *              0 or have the {@link InputMethodManager#SHOW_IMPLICIT} bit set.
     */
    public static void showSoftInput(final Context context, final View view, final int flags) {
     ...
     * @param activity The activity.
     */
    public static void hideSoftInput(Context context, final Activity activity) {
        View view = activity.getCurrentFocus();
        if (view == null) {
            view = new View(activity);
        }
