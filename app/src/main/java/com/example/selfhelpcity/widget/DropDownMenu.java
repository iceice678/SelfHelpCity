package com.example.selfhelpcity.widget;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpTpPx(40));
    ...
    public void setTabText(String text) {
        if (current_tab_position != -1) {
            ((TextView) tabMenuView.getChildAt(current_tab_position)).setGravity(Gravity.CENTER);
